...
# │   └── live\_feed.py               # Camera backend logic

# │   └──live\_predict.py            # Standalone real-time inference script

# ├── src/

# │   └── predict\_video.py           # Batch video processing script

# ├── tools/

# │   └── train\_bdd.py               # YOLOv11 training pipeline

# │   └──verify\_dataset.py          # Dataset consistency checker

# │   └── find\_camera\_id.py          # Utility to scan for available camera indices

# ├── UI/

# │   └── control\_panel.py       # Main Graphical User Interface (Full integrated System)
...
# \- Navigate to the weights file (e.g., `runs/detect/bdd11s\_base/best.onnx`) and select it.
...
# python tools/find\_camera\_id.py
...
# \*\*Note:\*\* Recorded videos will be saved in the `videos/` directory with a timestamped filename (e.g., `recording\_20231025\_120000.mp4`).
